...
const ThreeDModel = () => {
    ...
    useEffect(() => {
        ...
        const canvasWidth = 110; // Define el tamaño en píxeles
        const canvasHeight = 100; // Define el tamaño en píxeles
        ...
        const planoGeometry = new THREE.PlaneGeometry(3, 5, 1, 1);
