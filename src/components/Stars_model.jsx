...
Command: npx gltfjsx@6.5.0 stars_model.glb 
...
export function Stars_model(props) {
  const group = React.useRef()
  const { nodes, materials, animations } = useGLTF('/models/stars_model.glb')
...
useGLTF.preload('/models/stars_model.glb')
