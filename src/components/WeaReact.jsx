...
const WeaReact = () => {
    const mountRef = useRef(null);
        ...
        useEffect(() => {
            ...
            const canvasWidth = 410; // Define el tamaño en píxeles
            const canvasHeight = 400; // Define el tamaño en píxeles
            ...
            if (mountRef.current) {
                renderer.domElement.className = "rounded-full"; // Clases de Tailwind
                mountRef.current.appendChild(renderer.domElement);
            }
    
            // ajuste de tamano del plano
            const planoGeometry = new THREE.PlaneGeometry(8, 7, 1, 1);
        ...
        return <div className='flex rounded px-2 py- justify-center border border-black'>
            
            <div className='flex rounded border border-black' ref={mountRef} />
    
        </div>;
    };
export default WeaReact;
