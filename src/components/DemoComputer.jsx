...
const DemoComputer = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF('/portafolio/public/models/computer.glb');
  const { actions } = useAnimations(animations, group);

  const txt = useVideoTexture(props.texture ? props.texture : '/portafolio/public/textures/project/project1.mp4');
...
useGLTF.preload('/portafolio/public/models/computer.glb');
