...
export const myProjects = [
  {
    ...
    texture: '/portafolio/public/textures/project/project1.mp4',
    logo: '/portafolio/public/assets/38.png',
    logoStyle: {
      backgroundColor: '#2A1816',
      border: '0.2px solid #36201D',
      boxShadow: '0px 0px 60px 0px #AA3C304D',
    },
    spotlight: '/portafolio/public/assets/spotlight1.png',
    tags: [
      {
        id: 1,
        name: 'React.js',
        path: '/portafolio/public/assets/react.svg',
      },
      {
        id: 2,
        name: 'TailwindCSS',
        path: '/portafolio/public/assets/tailwindcss.png',
      },
      {
        id: 3,
        name: 'Django',
        path: '/portafolio/public/assets/logodjango.png',
      },
      {
        id: 4,
        name: 'Threejs',
        path: '/portafolio/public/assets/logothreejs.png',
      },
    ],
  },
  {
    ...
    tags: [
      ...
      },
      {
        id: 3,
        name: 'TypeScript',
        path: '/portafolio/public/assets/nodejs.png',
      },
      {
        id: 4,
        name: 'Framer Motion',
