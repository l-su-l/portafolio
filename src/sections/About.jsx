            ...
            <div className=' bg-zinc-800 rounded px-1 py-1 w-full h-full'>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 pl-2">
                  <img src={`${import.meta.env.BASE_URL}assets/iconochile.png`} alt="iconchile" className='w-[32px] h-[20px] rounded' />
              ...
              <div className="space-y-2">
                <div className="flex gap-3 pl-2 pt-1">
                  <img src={`${import.meta.env.BASE_URL}assets/globo-terraqueo.png`} alt="iconchile" className='h-[5%] rounded' />
