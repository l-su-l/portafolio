            ...
            <div className=' bg-zinc-800 rounded px-1 py-1'>
              ...
              <div className="space-y-2 px-1">
                <div className="flex gap-1" onClick={handleCopy}>
                  <img src={hasCopied ? 'assets/tick.svg' : 'assets/copy.svg'} alt="copy" className='cursor-pointer z-50'/>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 pl-2">
                  <img src={'assets/iconochile.png'} alt="iconchile" className='w-[32px] h-[20px] rounded' />
              ...
              <div className="space-y-2">
                <div className="flex gap-3 pl-2 pt-1">
                  <img src={'assets/globo-terraqueo.png'} alt="iconchile" className='h-[5%] rounded' />
